# Contributing to yearn-finance

Love yearn-finance and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/iearn-finance/yearn-finance/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/yearn-finance.git
    # Navigate to the newly cloned directory
    cd yearn-finance
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/iearn-finance/yearn-finance.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/iearn-finance/yearn-finance/blob/develop/LICENSE.md).
